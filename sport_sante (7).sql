...
INSERT INTO `categorie_activite` (`fk_categorie`, `fk_activite`) VALUES
(1, 1),
(2, 1),
(3, 1),
(4, 1),
...
CREATE TABLE `Club` (
  ...
  `ccordonnees` varchar(50) DEFAULT NULL,
...
--
-- Contenu de la table `club_activite`
--

INSERT INTO `club_activite` (`fk_club`, `fk_activite`) VALUES
(5, 1),
(5, 2),
(6, 3),
(7, 4),
...
(1163, '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.81 Safari/537.36', 'http://localhost/SportSante2/sport_sante/public/admin/logout', 'admin@crudbooster.com logout', '', 1, '2018-10-26 10:04:07', NULL),
(1164, '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.81 Safari/537.36', 'http://localhost/SportSante2/sport_sante/public/admin/login', 'admin@crudbooster.com login with IP Address ::1', '', 1, '2018-10-26 10:04:18', NULL),
(1165, '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.81 Safari/537.36', 'http://localhost/SportSante2/sport_sante/public/admin/logout', 'admin@crudbooster.com logout', '', 1, '2018-10-26 10:05:14', NULL),
(1166, '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.81 Safari/537.36', 'http://localhost/SportSante2/sport_sante/public/admin/login', 'test@test.com login with IP Address ::1', '', 2, '2018-10-26 10:05:30', NULL),
(1167, '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.81 Safari/537.36', 'http://localhost/SportSante2/sport_sante/public/admin/logout', 'test@test.com logout', '', 2, '2018-10-26 10:06:56', NULL),
(1168, '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.81 Safari/537.36', 'http://localhost/SportSante2/sport_sante/public/admin/login', 'test@test.com login with IP Address ::1', '', 2, '2018-10-26 10:07:30', NULL),
(1169, '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.81 Safari/537.36', 'http://localhost/SportSante2/sport_sante/public/admin/logout', 'test@test.com logout', '', 2, '2018-10-26 10:43:29', NULL),
(1170, '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.81 Safari/537.36', 'http://localhost/SportSante2/sport_sante/public/admin/login', 'admin@crudbooster.com login with IP Address ::1', '', 1, '2018-10-26 10:44:01', NULL);
...
(12, 'logo', 'uploads/2018-10/73d828e7f71cf2cff22aa5f10e358d5d.png', 'upload_image', NULL, NULL, '2018-10-16 10:59:44', NULL, 'Application Setting', 'Logo'),
(13, 'favicon', 'uploads/2018-10/ff951559ba9f32ff4f2032c004029d4a.png', 'upload_image', NULL, NULL, '2018-10-16 10:59:44', NULL, 'Application Setting', 'Favicon'),
...
(2, 'logo de l\'application', '6ko', 'png', 'image/2.png', NULL),
...
(1, 'Bouge avec ton école/collège'),
(2, 'Les rendez-vous sportifs'),
(3, 'Label Éco-centre de loisirs'),
(4, 'Action Prévention Santé Jeunes (APSJ) / Journées des APS'),
(5, 'Bien-être au travail'),
(6, 'J\'équilibre ma santé'),
(7, 'Mon diabète, je Gers'),
(8, 'Pass 32'),
(9, 'Sport plus'),
(10, 'Bouger en EHPAD'),
(11, 'PEP\'S'),
(12, 'Oser Bouger'),
(13, 'Santé plus Gers'),
(14, 'Programme sport et Santé du Grand Auch ?'),
(15, 'Événements du CDOS');
...
INSERT INTO `reseaux` (`id`, `nom`, `descriptif`, `adresse`, `contact`, `telephone`, `mail`, `site_web`, `label`, `coordonnees`, `fk_image`) VALUES
(1, 'efFORMip ', 'Depuis sa création en 2005, efFORMip agit en faveur du développement de la prescription d’Activités Physiques et Sportives (APS) pour les porteurs de pathologies chroniques.', 'Hôpital La Grave\r\n2, place Lange\r\nTSA 60033\r\n31059 Toulouse Cedex 9', NULL, '05 67 06 64 76', 'contact@efformip.fr', 'https://www.efformip.com/', NULL, '[43.600961,1.434258]', NULL),
(2, 'Arpège 32', NULL, '9 avenue de la marne\r\n32000 AUCH', NULL, '05 62 07 17 53', 'contact@reseau-arpege32.fr', 'http://www.reseau-arpege32.fr', NULL, '[43.648536,43.648536]', NULL);
